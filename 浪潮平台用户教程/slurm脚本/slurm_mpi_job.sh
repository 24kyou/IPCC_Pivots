...
#SBATCH --mail-user=yangyanwei@inspur.com    # Where to send mail.  Set this to your email address
...
module load intel/2020.1.217 openmpi/3.0.0
srun --mpi=pmix_v1 /data/training/SLURM/mpi_job/application_mpi
